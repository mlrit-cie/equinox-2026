...
export const events = [
  ...
  },
  {
    slug: "ipl-auction",
    name: "IPL Auction",
    tagline: "Bid for players, build your dream squad",
    category: "Showcase",
    day: "Day 2",
    time: "13 Mar, 11.00 AM – 04.00 PM",
    venue: "Main Hall, Exhibition Wing",
    teamSize: "Individual or Team",
    fee: "Free",
    prize: "Top bids showcase",
    about: [
      "A live-style auction experience where attendees form franchises and bid on players in a simulated IPL auction.",
      "Strategy, budgeting and fast decisions win the day — bring your negotiation skills.",
    ],
    rules: [
      "Teams/franchises must register before the auction",
      "Bids are simulated and for showcase purposes only",
      "Auction rules and player lists are published 30 minutes before start",
      "Prize for the highest scoring simulated squad",
    ],
    spoc: { name: "Event SPOC Three", email: "iplauction.equinox@gmail.com", phone: "+91 90000 00003" },
  },
  {
    slug: "code-sprint",
    name: "Code Sprint",
...
export const registration = {
  ...
  steps: [
    ...
    { title: "Register your team", body: "For hackathon, ideathon, IPL auction and the rest, register the team on the event's page and confirm with its SPOC." },
